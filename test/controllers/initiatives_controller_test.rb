...
class InitiativesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create initiative" do
    assert_difference('Initiative.count') do
      post initiatives_url, params: { initiative: { description: @initiative.description, title: @initiative.title, user_id: @initiative.user_id } }
    end
  ...
  test "should update initiative" do
    patch initiative_url(@initiative), params: { initiative: { description: @initiative.description, title: @initiative.title, user_id: @initiative.user_id } }
