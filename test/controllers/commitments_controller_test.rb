...
class CommitmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commitment" do
    assert_difference('Commitment.count') do
      post commitments_url, params: { commitment: { action: @commitment.action, content: @commitment.content, due_date: @commitment.due_date, initiative_id: @commitment.initiative_id, start_date: @commitment.start_date, user_id: @commitment.user_id } }
    end
  ...
  test "should update commitment" do
    patch commitment_url(@commitment), params: { commitment: { action: @commitment.action, content: @commitment.content, due_date: @commitment.due_date, initiative_id: @commitment.initiative_id, start_date: @commitment.start_date, user_id: @commitment.user_id } }
